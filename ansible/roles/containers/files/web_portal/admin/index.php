...
<head>
<meta charset="UTF-8">
<title>管理者パネル - TAKAI ALLIANCE</title>
...
<div class="wrapper">
  ...
  <div class="menu-box">
    <a href="/admin/docker_panel.php" class="menu-btn">🚀 コンテナ管理</a>
    <a href="/admin/service_settings.php" class="menu-btn">⚙️ サービス設定</a>
    <a href="/admin/game_console.php" class="menu-btn">🎮 ゲームコンソール</a>
    <a href="/admin/game_config.php" class="menu-btn">🛠️ ゲーム設定</a>
    <a href="/admin/log_viewer.php" class="menu-btn">📜 ログビューア</a>
  </div>
</div>
