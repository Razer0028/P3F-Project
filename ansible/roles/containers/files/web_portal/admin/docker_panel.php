...
<header class="site-header">
  <div class="brand-block">
    ...
    <div class="brand-texts">
      ...
      <div class="brand-sub">コンテナ管理 / 内部管理用</div>
    </div>
  </div>

  <div class="header-right">
    <div class="login-user">ログイン中: <?= h($_SESSION['user_email'] ?? '不明') ?></div>
...
<main class="main-wrap">
  ...
  <section class="left-col">
    ...
    <div class="card">
      <div class="card-head">
        <div class="iconbox"><img src="/images/soldir.jpg" alt="コンテナなし"></div>
    ...
    <div class="card">
      <div class="card-head">
        <div class="iconbox"><img src="/images/soldir.jpg" alt="カタログ"></div>
        <div class="head-texts">
          <div class="head-title-row">
  ...
  <section class="right-col">
    ...
    <div class="card">
      <div class="card-head">
        <div class="iconbox"><img src="/images/soldir.jpg" alt="サーバー"></div>
        <div class="head-texts">
          <div class="head-title-row">
            <span>サーバーリソース状況</span>
          </div>
          <div class="head-sub">CPU 負荷 / 稼働時間 / メモリ / ディスク</div>
        </div>
      </div>
      <div class="card-body">
        <div class="stat-grid">
          <div class="stat-card">
            <div class="stat-label">CPU 負荷</div>
            ...
            <?php if ($cpuLoadPercent !== null): ?>
              ...
              <div class="stat-meta"><?= h($cpuLoadPercent) ?>% / <?= h($cpuCount) ?> コア</div>
            <?php else: ?>
          ...
          <div class="stat-card">
            ...
            <?php if ($memUsedPercent !== null): ?>
              ...
              <div class="stat-meta"><?= h($memUsedPercent) ?>% 使用</div>
            <?php else: ?>
          ...
          <div class="stat-card">
            ...
            <?php if ($diskUsedPercent !== null): ?>
              ...
              <div class="stat-meta"><?= h($diskUsedPercent) ?>% 使用</div>
            <?php else: ?>
          ...
          <div class="stat-card">
            ...
            <div class="stat-value"><?= h($uptimeShort ?: '取得不可') ?></div>
    ...
    <div class="card">
      <div class="card-head">
        <div class="iconbox"><img src="/images/ark.png" alt="ログ"></div>
        <div class="head-texts">
          <div class="head-title-row">
      ...
      <div class="card-body">
        <div class="section-block">
          <div class="section-title">参加 / 退出 / 自動停止</div>
    ...
    <div class="card">
      <div class="card-head">
        <div class="iconbox"><img src="/images/minecraft.png" alt="ホワイトリスト"></div>
        <div class="head-texts">
          <div class="head-title-row">
        ...
        <div class="section-block">
          ...
          <div class="wl-list">
            ...
            <div class="wl-row">
              ...
              <form method="post" style="margin:0;" onsubmit="return confirm(<?= h(json_encode($pname . ' を削除しますか？', JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE)) ?>);">
